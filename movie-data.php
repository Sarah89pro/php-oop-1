 ...
 */
 ...
 $movies = [
    [
        'title' =>'Crudelia',
        'distribuited_by' =>'Walt Disney',
        'director' =>'Craig Gillespie',
        'plot' =>'Estella è una bambina con un sogno e un lato oscuro: il sogno è quello di diventare una celebre stilista di moda,
    ...
    [
        'title' =>'The Witches',
        'distribuited_by' =>'Warner Bros',
        'director' =>'Robert Zemeckis',
        'plot' =>'Rimasto orfano dopo un incidente, un bambino di otto anni va a vivere a Demopolis, in Alabama, con la nonna.
    ...
    [
        'title' =>'Sul più bello',
        'distribuited_by' =>'Eagle Pictures',
        'director' =>'Alice Filippi',
        'plot' =>'Marta è bruttina e sa di esserlo. Per di più soffre di una rara malattia che non le permetterà di invecchiare, e che può
